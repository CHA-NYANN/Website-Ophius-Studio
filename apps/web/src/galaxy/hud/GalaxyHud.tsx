...
export function GalaxyHud() {
  // Disabled per UI request (mobile overlap / visual clutter).
  // Set to true if you want to bring it back later.
  const ENABLE_SEARCH_PANELS_HUD = false;
  ...
  if (!show) return null;
  if (!ENABLE_SEARCH_PANELS_HUD) return null;
